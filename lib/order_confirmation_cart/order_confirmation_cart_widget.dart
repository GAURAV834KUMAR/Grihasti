...
import 'order_confirmation_cart_model.dart';
export 'order_confirmation_cart_model.dart';
...
class _OrderConfirmationCartWidgetState
  ...
  late OrderConfirmationCartModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrderConfirmationCartModel());
