...
import '/main.dart';
import '/order_confirmation_cart/order_confirmation_cart_widget.dart';
import 'package:auto_size_text/auto_size_text.dart';
import 'package:flutter/material.dart';
import 'package:flutter_spinkit/flutter_spinkit.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';
import 'delivery_address_cart_model.dart';
export 'delivery_address_cart_model.dart';

class DeliveryAddressCartWidget extends StatefulWidget {
  const DeliveryAddressCartWidget({
    Key? key,
    this.odid,
    this.amount,
  }) : super(key: key);
  ...
  @override
  _DeliveryAddressCartWidgetState createState() =>
      _DeliveryAddressCartWidgetState();
}

class _DeliveryAddressCartWidgetState extends State<DeliveryAddressCartWidget> {
  late DeliveryAddressCartModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeliveryAddressCartModel());
  }
                                          ...
                                          await Navigator.push(
                                            ...
                                            PageTransition(
                                              ...
                                              reverseDuration:
                                                  Duration(milliseconds: 300),
                                              child:
                                                  OrderConfirmationCartWidget(
                                                aid: listViewAdressRecord,
                                                odid: widget.odid,
