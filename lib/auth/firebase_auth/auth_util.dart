...
DocumentReference? get currentUserReference =>
    loggedIn ? ViratUserRecord.collection.doc(currentUser!.uid) : null;

ViratUserRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : ViratUserRecord.getDocument(ViratUserRecord.collection.doc(uid))
              .handleError((_) {}),
    )
